defmodule Mix.Tasks.Delete.Random.Venues do
  use Mix.Task

  @shortdoc "Deletes a random set of venues from a specific scraper source"

  @moduledoc """
  Deletes a random set of venues from a specific scraper source.

  ## Usage

      mix delete.random.venues [scraper_name] [optional: count]

  ## Examples

      mix delete.random.venues inquizition 5
      mix delete.random.venues question_one 10
      mix delete.random.venues speed_quizzing 3
  """
