defmodule TriviaAdvisor.Scraping.RateLimiter do
  ...
  @defaults %{
    ...
    priority: 3,
    # Number of days to skip processing venues/events if they've been updated recently
  ...
  @doc """
  Returns the number of days to skip processing venues/events if they've been updated recently.
  """
