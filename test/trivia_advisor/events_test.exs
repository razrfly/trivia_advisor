defmodule TriviaAdvisor.EventsTest do
  ...
  describe "events" do
    ...
    test "create_event/1 with valid data creates a event" do
      valid_attrs = %{description: "some description", title: "some title", day_of_week: 42, start_time: ~T[14:00:00], frequency: 42, entry_fee_cents: 42}
  ...
  describe "event_sources" do
    ...
    test "create_event_source/1 with valid data creates a event_source" do
      valid_attrs = %{status: "some status", metadata: %{}, source_url: "some source_url", last_seen_at: ~U[2025-02-09 21:21:00Z]}
